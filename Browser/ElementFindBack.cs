// =============================================================================
// ElementFindBack.cs — активность «Найти элемент».
//
// Находит элемент на странице по заданному локатору.
// Возвращает ID элемента для дальнейшей работы.
//
// Используется для:
//   - Поиска элементов перед взаимодействием
//   - Проверки наличия элементов
//   - Сохранения ссылок на элементы
// =============================================================================
...
{
    /// <summary>
    /// Активность для поиска элемента на странице по локатору.
    /// </summary>
    public class ElementFindBack : PrimoComponentTO<ElementFind>
    {
        ...
        /// <summary>ID найденного элемента.</summary>
        [LTools.Common.Model.Serialization.StoringProperty]
        [LTools.Common.Model.Studio.ValidateReturnScript(DataType = typeof(string))]
        ...
        {
            sdkComponentName = ActivityStrings.Activity_ElementFind;
            sdkComponentHelp =
                ...
                "\n" +
                "── Выходные параметры ─────────────────────────\n" +
                "ID элемента  — идентификатор найденного элемента\n" +
                "\n" +
                "ПРИМЕЧАНИЕ: Элемент сохраняется в RepoDict с уникальным ID.";
        ...
        public override ExecutionResult TimedAction(ScriptingData sd)
        {
            try
            {
                ...
                // Генерация ID и сохранение элемента
                ...
                {
                    IsSuccess = true,
                    SuccessMessage = $"[Найти элемент] Элемент найден: {this.Prop_LocatorType}={locatorValue}, ID={elementId}"
                };
            }
            catch (Exception ex)
            {
                ...
                {
                    IsSuccess = false,
                    ErrorMessage = $"Ошибка [Найти элемент]: {ex.Message}"
                };
            }
        }
